...
def iter_sessions(
    ...
    Args:
        data_path: 数据文件路径，默认使用 /share/home/qmzhu/AGMS/data/locomo/locomo10.json
    ...
    if data_path is None:
        data_path = "/share/home/qmzhu/AGMS/data/locomo/locomo10.json"
...
if __name__ == "__main__":
    ...
    count = 0
    for session in iter_sessions(limit=2):
        count += 1
        print(f"\nSession {count}:")
