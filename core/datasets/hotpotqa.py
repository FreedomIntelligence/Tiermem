...
参考实现：
- /share/home/qmzhu/AGMS/relatedwork/general-agentic-memory/eval/hotpotqa_test.py
"""
import json
...
def iter_sessions(
    ...
    Args:
        data_dir: 数据目录路径，默认使用 /share/home/qmzhu/AGMS/data/hotpot_qa
    ...
    """
    if data_dir is None:
        data_dir = "/share/home/qmzhu/AGMS/data/hotpot_qa"
