...
from ..configs.llms.anthropic import AnthropicConfig
from ..configs.llms.azure import AzureOpenAIConfig
from ..configs.llms.base import BaseLlmConfig
from ..configs.llms.deepseek import DeepSeekConfig
from ..configs.llms.lmstudio import LMStudioConfig
from ..configs.llms.ollama import OllamaConfig
from ..configs.llms.openai import OpenAIConfig
from ..configs.llms.vllm import VllmConfig
from ..configs.rerankers.base import BaseRerankerConfig
from ..configs.rerankers.cohere import CohereRerankerConfig
from ..configs.rerankers.sentence_transformer import SentenceTransformerRerankerConfig
from ..configs.rerankers.zero_entropy import ZeroEntropyRerankerConfig
from ..configs.rerankers.llm import LLMRerankerConfig
from ..configs.rerankers.huggingface import HuggingFaceRerankerConfig
from ..embeddings.mock import MockEmbeddings


def load_class(class_type):
    """Load a class by its module path.

    Supports both 'mem0.xxx' and 'src.mem0.xxx' prefixes for compatibility
    ...
    # 尝试多种导入前缀
    prefixes_to_try = [
        module_path,  # 原始路径 (mem0.xxx)
        f"src.{module_path}",  # 加 src 前缀 (src.mem0.xxx)
    ]
    ...
    # 如果都失败了，抛出最后的错误
    raise ImportError(f"Cannot import {class_type}: {last_error}")
